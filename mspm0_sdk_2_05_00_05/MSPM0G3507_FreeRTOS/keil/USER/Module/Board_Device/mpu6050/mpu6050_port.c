...
{
    const TickType_t timeout_ticks = pdMS_TO_TICKS(MPU6050_I2C_TIMEOUT_MS);
...
void mpu6050_port_get_ms(unsigned long *milliseconds)
{
    if (milliseconds != NULL) {
        *milliseconds = (unsigned long) xTaskGetTickCount() *
